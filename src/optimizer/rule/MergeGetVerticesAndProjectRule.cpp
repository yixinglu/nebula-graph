...
MergeGetVerticesAndProjectRule::MergeGetVerticesAndProjectRule() { RuleSet::QueryRules().addRule(this); }

const Pattern &MergeGetVerticesAndProjectRule::pattern() const {
  static Pattern pattern = Pattern::create(PlanNode::Kind::kGetVertices, {Pattern::create(PlanNode::Kind::kProject)});
  return pattern;
}
...
StatusOr<OptRule::TransformResult> MergeGetVerticesAndProjectRule::transform(OptContext *ctx,
...
std::string MergeGetVerticesAndProjectRule::toString() const { return "MergeGetVerticesAndProjectRule"; }
