...
const Pattern &MergeGetNbrsAndProjectRule::pattern() const {
  static Pattern pattern =
      Pattern::create(graph::PlanNode::Kind::kGetNeighbors, {Pattern::create(graph::PlanNode::Kind::kProject)});
  return pattern;
}
...
StatusOr<OptRule::TransformResult> MergeGetNbrsAndProjectRule::transform(OptContext *ctx,
