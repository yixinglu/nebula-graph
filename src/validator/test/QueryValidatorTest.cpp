...
TEST_F(QueryValidatorTest, GoZeroStep) {
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kProject, PK::kLeftJoin, PK::kProject,     PK::kGetNeighbors,
                                            PK::kDedup,   PK::kProject,  PK::kPassThrough, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
...
TEST_F(QueryValidatorTest, GoNSteps) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kProject, PK::kGetNeighbors, PK::kLoop,         PK::kStart,
                                            PK::kDedup,   PK::kProject,      PK::kGetNeighbors, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query = "GO 3 STEPS FROM \"1\",\"2\",\"3\" OVER like WHERE like.likeness > 90";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject, PK::kFilter,  PK::kGetNeighbors, PK::kLoop,  PK::kStart,
        PK::kDedup,   PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kDedup, PK::kProject, PK::kFilter,       PK::kGetNeighbors, PK::kLoop,
        PK::kStart,       PK::kDedup, PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
        ...
        "YIELD distinct $^.person.name ";
    std::vector<PlanNode::Kind> expected = {PK::kDataCollect,  PK::kDedup,        PK::kProject, PK::kFilter,
                                            PK::kGetNeighbors, PK::kLoop,         PK::kStart,   PK::kDedup,
...
TEST_F(QueryValidatorTest, GoWithPipe) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kProject, PK::kLeftJoin, PK::kLeftJoin,     PK::kProject, PK::kGetNeighbors, PK::kLoop,
        PK::kDedup,   PK::kDedup,    PK::kProject,      PK::kProject, PK::kDedup,        PK::kLeftJoin,
        PK::kProject, PK::kDedup,    PK::kProject,      PK::kProject, PK::kGetNeighbors, PK::kDedup,
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kProject,      PK::kLeftJoin, PK::kProject, PK::kGetNeighbors,
                                            ...
                                            PK::kLoop,         PK::kStart,    PK::kDedup,   PK::kProject,
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kProject, PK::kLeftJoin, PK::kProject, PK::kGetNeighbors,
                                            PK::kDedup,   PK::kProject,  PK::kProject, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
    ...
    std::vector<PlanNode::Kind> expected = {PK::kProject,      PK::kLeftJoin,     PK::kProject,
                                            PK::kGetNeighbors, PK::kDedup,        PK::kProject,
                                            PK::kProject,      PK::kGetNeighbors, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kProject,      PK::kFilter, PK::kLeftJoin, PK::kProject,
                                            PK::kGetNeighbors, PK::kDedup,  PK::kProject,  PK::kProject,
                                            PK::kGetNeighbors, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kDataCollect, PK::kDedup,   PK::kProject,      PK::kFilter,
                                            PK::kLeftJoin,    PK::kProject, PK::kGetNeighbors, PK::kDedup,
                                            PK::kProject,     PK::kProject, PK::kGetNeighbors, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
  ...
  }
  {
    std::string query =
        ...
        "WHERE $-.id == \"2\" YIELD $-.id, like._dst";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject,  PK::kFilter,  PK::kLeftJoin, PK::kLeftJoin,     PK::kProject, PK::kGetNeighbors,
        PK::kLoop,     PK::kDedup,   PK::kDedup,    PK::kProject,      PK::kProject, PK::kDedup,
        PK::kLeftJoin, PK::kProject, PK::kDedup,    PK::kProject,      PK::kProject, PK::kGetNeighbors,
  ...
  }
  {
    std::string query =
        ...
        "WHERE $-.id == \"2\" YIELD DISTINCT $-.id, like._dst";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kDedup,   PK::kProject,      PK::kFilter,       PK::kLeftJoin,
        PK::kLeftJoin,    PK::kProject, PK::kGetNeighbors, PK::kLoop,         PK::kDedup,
        PK::kDedup,       PK::kProject, PK::kProject,      PK::kDedup,        PK::kLeftJoin,
  ...
  }
  {
    std::string query =
        ...
        "$$.person.name";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject,      PK::kLeftJoin, PK::kLeftJoin,     PK::kProject, PK::kGetVertices, PK::kProject,
        PK::kGetNeighbors, PK::kDedup,    PK::kProject,      PK::kProject, PK::kLeftJoin,    PK::kProject,
        PK::kGetVertices,  PK::kProject,  PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
        ...
        "$$.person.name";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kDedup,   PK::kProject,      PK::kLeftJoin, PK::kLeftJoin,     PK::kProject,
        PK::kGetVertices, PK::kProject, PK::kGetNeighbors, PK::kDedup,    PK::kProject,      PK::kProject,
        PK::kLeftJoin,    PK::kProject, PK::kGetVertices,  PK::kProject,  PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kProject,      PK::kLeftJoin, PK::kLeftJoin, PK::kProject, PK::kGetVertices,  PK::kProject,
        PK::kGetNeighbors, PK::kDedup,    PK::kProject,  PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
        ...
        "$$.person.name";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject,      PK::kLeftJoin,     PK::kLeftJoin, PK::kLeftJoin,     PK::kProject, PK::kGetVertices,
        PK::kProject,      PK::kGetNeighbors, PK::kLoop,     PK::kDedup,        PK::kDedup,   PK::kProject,
        PK::kProject,      PK::kDedup,        PK::kLeftJoin, PK::kProject,      PK::kDedup,   PK::kProject,
        PK::kProject,      PK::kLeftJoin,     PK::kDedup,    PK::kProject,      PK::kProject, PK::kGetVertices,
  ...
  }
  {
    std::string query =
        ...
        "$$.person.name";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kDedup,       PK::kProject,      PK::kLeftJoin,     PK::kLeftJoin, PK::kLeftJoin,
        PK::kProject,     PK::kGetVertices, PK::kProject,      PK::kGetNeighbors, PK::kLoop,     PK::kDedup,
        PK::kDedup,       PK::kProject,     PK::kProject,      PK::kDedup,        PK::kLeftJoin, PK::kProject,
        PK::kDedup,       PK::kProject,     PK::kProject,      PK::kLeftJoin,     PK::kDedup,    PK::kProject,
        PK::kProject,     PK::kGetVertices, PK::kGetNeighbors, PK::kProject,      PK::kStart,    PK::kGetNeighbors,
        PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kProject, PK::kGetNeighbors, PK::kProject, PK::kGetNeighbors,
                                            PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
}
...
TEST_F(QueryValidatorTest, GoReversely) {
  {
    std::string query =
        ...
        "YIELD $$.person.name";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject, PK::kLeftJoin, PK::kProject, PK::kGetVertices, PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        ...
        PK::kLoop,    PK::kStart,    PK::kDedup,   PK::kProject,     PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
}
...
TEST_F(QueryValidatorTest, GoOneStep) {
  ...
  }
  {
    std::string query =
        ...
        "$$.person.name, $$.person.age + 1";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject,     PK::kFilter,  PK::kLeftJoin,     PK::kProject,
        PK::kGetVertices, PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kDedup,       PK::kProject, PK::kFilter,       PK::kLeftJoin,
        PK::kProject,     PK::kGetVertices, PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
  ...
  }
  {
    std::string query =
        ...
        "YIELD distinct $^.person.name ";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kDedup, PK::kProject, PK::kFilter, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
  ...
  }
  {
    std::string query =
        ...
        "| GO FROM $-.id OVER like";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject, PK::kLeftJoin, PK::kProject,      PK::kGetNeighbors, PK::kDedup,
        PK::kProject, PK::kProject,  PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
...
TEST_F(QueryValidatorTest, OutputToAPipe) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kProject, PK::kLeftJoin, PK::kProject,  PK::kGetNeighbors, PK::kDedup,
        PK::kProject, PK::kProject,  PK::kLeftJoin, PK::kProject,      PK::kGetNeighbors,
        PK::kDedup,   PK::kProject,  PK::kProject,  PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
}
...
TEST_F(QueryValidatorTest, GoMToN) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kLoop,    PK::kStart,        PK::kDedup, PK::kProject,
        PK::kDedup,       PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kLoop,    PK::kStart, PK::kDedup,   PK::kProject,      PK::kLeftJoin, PK::kProject,
        PK::kGetVertices, PK::kProject, PK::kDedup, PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kLoop, PK::kStart, PK::kProject, PK::kDedup, PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kLoop,    PK::kStart, PK::kProject, PK::kLeftJoin,     PK::kProject,
        PK::kGetVertices, PK::kProject, PK::kDedup, PK::kProject, PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,  PK::kLoop,     PK::kDedup,        PK::kProject,  PK::kProject, PK::kLeftJoin,
        PK::kDedup,        PK::kLeftJoin, PK::kProject,      PK::kProject,  PK::kProject, PK::kDedup,
        PK::kGetNeighbors, PK::kProject,  PK::kStart,        PK::kLeftJoin, PK::kDedup,   PK::kProject,
        PK::kDedup,        PK::kProject,  PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
...
TEST_F(QueryValidatorTest, Limit) {
  ...
  {
    std::string query = "GO FROM \"Ann\" OVER like YIELD like._dst AS like | LIMIT 1, 3";
    std::vector<PlanNode::Kind> expected = {PK::kDataCollect, PK::kLimit, PK::kProject, PK::kGetNeighbors, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
}
...
TEST_F(QueryValidatorTest, OrderBy) {
  {
    std::string query =
        ...
        " | ORDER BY $-.age";
    std::vector<PlanNode::Kind> expected = {PK::kDataCollect, PK::kSort, PK::kProject, PK::kGetNeighbors, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  // not exist factor
  {
...
TEST_F(QueryValidatorTest, OrderByAndLimt) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {PK::kDataCollect, PK::kLimit,        PK::kSort,
                                            PK::kProject,     PK::kGetNeighbors, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
}
...
TEST_F(QueryValidatorTest, TestSetValidator) {
  // UNION ALL
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,  PK::kUnion,        PK::kProject,     PK::kProject,
        PK::kGetNeighbors, PK::kGetNeighbors, PK::kPassThrough, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  // UNION DISTINCT twice
  {
    std::string query =
        ...
        "like.start AS start";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,  PK::kDedup,        PK::kUnion,   PK::kDedup,       PK::kProject,
        PK::kUnion,        PK::kGetNeighbors, PK::kProject, PK::kProject,     PK::kPassThrough,
        PK::kGetNeighbors, PK::kGetNeighbors, PK::kStart,   PK::kPassThrough,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  // UNION DISTINCT
  {
    std::string query =
        ...
        "OVER like YIELD like.start AS start";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,  PK::kDedup,        PK::kUnion,       PK::kProject, PK::kProject,
        PK::kGetNeighbors, PK::kGetNeighbors, PK::kPassThrough, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  ...
  // INTERSECT
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,  PK::kIntersect,    PK::kProject,     PK::kProject,
        PK::kGetNeighbors, PK::kGetNeighbors, PK::kPassThrough, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  // MINUS
  {
    std::string query =
        ...
        "\"2\" OVER like YIELD like.start AS start";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,  PK::kMinus,        PK::kProject,     PK::kProject,
        PK::kGetNeighbors, PK::kGetNeighbors, PK::kPassThrough, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
...
TEST_F(QueryValidatorTest, TestMaxAllowedStatements) {
  ...
  stmts.emplace_back(folly::stringPrintf("CREATE TAG tag_%d(name string)", FLAGS_max_allowed_statements));
  query = folly::join(";", stmts);
  auto result = checkResult(query);
  EXPECT_FALSE(result);
  EXPECT_EQ(std::string(result.message()), "SemanticError: The maximum number of statements allowed has been exceeded");
}
...
TEST_F(QueryValidatorTest, TestMatch) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kProject, PK::kFilter,  PK::kProject,   PK::kInnerJoin, PK::kProject, PK::kGetVertices,
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kDedup,        PK::kProject, PK::kFilter,  PK::kProject,   PK::kInnerJoin,
        PK::kProject,     PK::kGetVertices,  PK::kDedup,   PK::kProject, PK::kInnerJoin, PK::kFilter,
        PK::kProject,     PK::kGetNeighbors, PK::kDedup,   PK::kProject, PK::kFilter,    PK::kProject,
        PK::kFilter,      PK::kGetNeighbors, PK::kDedup,   PK::kProject, PK::kIndexScan, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
        ...
        "RETURN type(r) AS Type, v2.name AS Name";
    std::vector<PlanNode::Kind> expected = {
        PK::kProject,     PK::kFilter,  PK::kFilter,      PK::kProject, PK::kInnerJoin, PK::kProject,
        PK::kGetVertices, PK::kDedup,   PK::kProject,     PK::kFilter,  PK::kProject,   PK::kGetNeighbors,
        PK::kDedup,       PK::kProject, PK::kPassThrough, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kProject,     PK::kFilter,  PK::kFilter,  PK::kProject, PK::kInnerJoin,          PK::kProject,
        PK::kGetVertices, PK::kDedup,   PK::kProject, PK::kFilter,  PK::kUnionAllVersionVar, PK::kLoop,
        PK::kProject,     PK::kFilter,  PK::kFilter,  PK::kProject, PK::kGetNeighbors,       PK::kInnerJoin,
        PK::kDedup,       PK::kProject, PK::kProject, PK::kFilter,  PK::kPassThrough,        PK::kGetNeighbors,
        PK::kStart,       PK::kDedup,   PK::kProject, PK::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
