...
TEST_F(MatchValidatorTest, SeekByTagIndex) {
  // empty properties index
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kProject, PlanNode::Kind::kFilter, PlanNode::Kind::kProject, PlanNode::Kind::kProject,
        // TODO this tag filter could remove in this case
        PlanNode::Kind::kFilter, PlanNode::Kind::kGetVertices, PlanNode::Kind::kDedup, PlanNode::Kind::kProject,
  ...
  // non empty properties index with extend
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        ...
        PlanNode::Kind::kInnerJoin,    PlanNode::Kind::kProject, PlanNode::Kind::kFilter,
...
TEST_F(MatchValidatorTest, groupby) {
  {
    std::string query =
        ...
        "labels(n) AS lb;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kAggregate, PlanNode::Kind::kFilter,      PlanNode::Kind::kProject, PlanNode::Kind::kProject,
        PlanNode::Kind::kFilter,    PlanNode::Kind::kGetVertices, PlanNode::Kind::kDedup,   PlanNode::Kind::kProject,
        PlanNode::Kind::kIndexScan, PlanNode::Kind::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
        ...
        "labels(n) AS lb;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kProject, PlanNode::Kind::kAggregate, PlanNode::Kind::kFilter,      PlanNode::Kind::kProject,
        PlanNode::Kind::kProject, PlanNode::Kind::kFilter,    PlanNode::Kind::kGetVertices, PlanNode::Kind::kDedup,
  ...
  }
  {
    std::string query =
        ...
        "ORDER BY id;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kDataCollect, PlanNode::Kind::kSort,    PlanNode::Kind::kProject, PlanNode::Kind::kAggregate,
        PlanNode::Kind::kFilter,      PlanNode::Kind::kProject, PlanNode::Kind::kProject, PlanNode::Kind::kFilter,
        PlanNode::Kind::kGetVertices, PlanNode::Kind::kDedup,   PlanNode::Kind::kProject, PlanNode::Kind::kIndexScan,
  ...
  }
  {
    std::string query =
        ...
        "SKIP 10 LIMIT 20;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kDataCollect, PlanNode::Kind::kLimit,       PlanNode::Kind::kSort,    PlanNode::Kind::kProject,
        PlanNode::Kind::kAggregate,   PlanNode::Kind::kFilter,      PlanNode::Kind::kProject, PlanNode::Kind::kProject,
        PlanNode::Kind::kFilter,      PlanNode::Kind::kGetVertices, PlanNode::Kind::kDedup,   PlanNode::Kind::kProject,
        PlanNode::Kind::kIndexScan,   PlanNode::Kind::kStart};
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
    std::string query =
        ...
        "labels(m) AS lb;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kAggregate, PlanNode::Kind::kFilter,  PlanNode::Kind::kProject,
  ...
  }
  {
    std::string query =
        ...
        "labels(m) AS lb;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kProject,      PlanNode::Kind::kAggregate, PlanNode::Kind::kFilter,
  ...
  }
  {
    std::string query =
        ...
        "SKIP 10 LIMIT 20;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kDataCollect, PlanNode::Kind::kLimit,   PlanNode::Kind::kAggregate,
  ...
  }
  {
    std::string query =
        ...
        "labels(m) AS lb;";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kDataCollect, PlanNode::Kind::kDedup,   PlanNode::Kind::kAggregate,
        PlanNode::Kind::kFilter,      PlanNode::Kind::kFilter,  PlanNode::Kind::kProject,
        PlanNode::Kind::kInnerJoin,   PlanNode::Kind::kProject, PlanNode::Kind::kGetVertices,
        PlanNode::Kind::kDedup,       PlanNode::Kind::kProject, PlanNode::Kind::kFilter,
        PlanNode::Kind::kProject,     PlanNode::Kind::kFilter,  PlanNode::Kind::kGetNeighbors,
...
TEST_F(MatchValidatorTest, with) {
  {
    std::string query =
        ...
        "RETURN average_age";
    std::vector<PlanNode::Kind> expected = {
        PlanNode::Kind::kProject, PlanNode::Kind::kProject,      PlanNode::Kind::kAggregate,
        PlanNode::Kind::kFilter,  PlanNode::Kind::kProject,      PlanNode::Kind::kInnerJoin,
        PlanNode::Kind::kProject, PlanNode::Kind::kGetVertices,  PlanNode::Kind::kDedup,
        PlanNode::Kind::kProject, PlanNode::Kind::kFilter,       PlanNode::Kind::kProject,
        PlanNode::Kind::kFilter,  PlanNode::Kind::kGetNeighbors, PlanNode::Kind::kDedup,
