...
TEST_F(FindPathValidatorTest, SinglePairPath) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect, PK::kLoop,         PK::kStart,        PK::kConjunctPath, PK::kBFSShortest,
        PK::kBFSShortest, PK::kGetNeighbors, PK::kGetNeighbors, PK::kPassThrough,  PK::kStart,
    };
...
TEST_F(FindPathValidatorTest, MultiPairPath) {
  ...
  {
    std::string query = "FIND SHORTEST PATH FROM \"1\",\"2\" TO \"3\",\"4\" OVER like UPTO 5 STEPS";
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,
        PK::kLoop,
        PK::kCartesianProduct,
...
TEST_F(FindPathValidatorTest, ALLPath) {
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,     PK::kLoop,  PK::kProject,      PK::kConjunctPath, PK::kProject,     PK::kProduceAllPaths,
        PK::kProduceAllPaths, PK::kStart, PK::kGetNeighbors, PK::kGetNeighbors, PK::kPassThrough, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
...
TEST_F(FindPathValidatorTest, RunTimePath) {
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,     PK::kLoop,  PK::kProject,      PK::kConjunctPath, PK::kProject,      PK::kProduceAllPaths,
        PK::kProduceAllPaths, PK::kDedup, PK::kGetNeighbors, PK::kGetNeighbors, PK::kProject,      PK::kPassThrough,
        PK::kDedup,           PK::kStart, PK::kProject,      PK::kProject,      PK::kGetNeighbors, PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
  {
  ...
  }
  {
    ...
    std::vector<PlanNode::Kind> expected = {
        PK::kDataCollect,     PK::kLoop,  PK::kProject,      PK::kConjunctPath, PK::kProject, PK::kProduceAllPaths,
        PK::kProduceAllPaths, PK::kDedup, PK::kGetNeighbors, PK::kGetNeighbors, PK::kProject, PK::kPassThrough,
        PK::kDedup,           PK::kStart, PK::kProject,      PK::kProject,      PK::kStart,
    };
    EXPECT_TRUE(checkResult(query, expected));
  }
}
