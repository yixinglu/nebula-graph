...
Status ValidatorTestBase::EqSelf(const PlanNode *l, const PlanNode *r) {
  ...
  if ((l->colNamesRef() != r->colNamesRef()) && l->kind() != PlanNode::Kind::kGetVertices) {
    return Status::Error("%s.colNames_ != %s.colNames_", l->outputVar().c_str(), r->outputVar().c_str());
  }
  switch (l->kind()) {
    ...
    case PlanNode::Kind::kDataCollect: {
      ...
      if (lDC->collectKind() != rDC->collectKind()) {
        return Status::Error("%s.collectKind_ != %s.collectKind_", l->outputVar().c_str(), r->outputVar().c_str());
      }
      return Status::OK();
    }
    ...
    case PlanNode::Kind::kGetEdges: {
      ...
      if (lGE->ranking() != nullptr && rGE->ranking() != nullptr) {
        if (lGE->ranking()->kind() != lGE->ranking()->kind()) {
          return Status::Error("%s.ranking_ != %s.ranking_", l->outputVar().c_str(), r->outputVar().c_str());
        }
      ...
      if (lGE->props() != rGE->props()) {
        return Status::Error("%s.props_ != %s.props_", l->outputVar().c_str(), r->outputVar().c_str());
      }
      return Status::OK();
    }
    case PlanNode::Kind::kProject: {
      ...
      if (lp->columns() == nullptr && rp->columns() == nullptr) {
        ...
        if (lCols.size() != rCols.size()) {
          return Status::Error("%s.columns_ != %s.columns_", l->outputVar().c_str(), r->outputVar().c_str());
        }
