...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> MockSchemaManager::getTagSchema(GraphSpaceID space, TagID tag,
                                                                                          SchemaVer) {
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> MockSchemaManager::getEdgeSchema(GraphSpaceID space,
                                                                                           EdgeType edge, SchemaVer) {
