...
class LookupValidator final : public Validator {
 public:
  LookupValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {}
 ...
 private:
  ...
  StatusOr<Value> checkConstExpr(Expression* expr, const std::string& prop, const Expression::Kind kind, bool leftIsAE);
