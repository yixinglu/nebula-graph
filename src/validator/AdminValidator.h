...
class DescSpaceValidator final : public Validator {
 public:
  DescSpaceValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) { setNoSpaceRequired(); }
...
class DropSpaceValidator final : public Validator {
 public:
  DropSpaceValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) { setNoSpaceRequired(); }
...
class ShowCreateSpaceValidator final : public Validator {
 public:
  ShowCreateSpaceValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {
    setNoSpaceRequired();
  }
...
class CreateSnapshotValidator final : public Validator {
 public:
  CreateSnapshotValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {
    setNoSpaceRequired();
  }
...
class RemoveListenerValidator final : public Validator {
 public:
  RemoveListenerValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {}
...
class ShowHostsValidator final : public Validator {
 public:
  ShowHostsValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) { setNoSpaceRequired(); }
...
class SetConfigValidator final : public Validator {
 public:
  SetConfigValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) { setNoSpaceRequired(); }
...
class GetConfigValidator final : public Validator {
 public:
  GetConfigValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) { setNoSpaceRequired(); }
...
class SignInTSServiceValidator final : public Validator {
 public:
  SignInTSServiceValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {
    setNoSpaceRequired();
  }
...
class SignOutTSServiceValidator final : public Validator {
 public:
  SignOutTSServiceValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {
    setNoSpaceRequired();
  }
