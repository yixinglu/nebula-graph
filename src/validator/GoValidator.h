...
class GoValidator final : public TraversalValidator {
 ...
 private:
  ...
  Status oneStep(PlanNode* dependencyForGn, const std::string& inputVarNameForGN, PlanNode* projectFromJoin);
  ...
  PlanNode* buildJoinPipeOrVariableInput(PlanNode* projectFromJoin, PlanNode* dependencyForJoinInput);
