...
class InsertVerticesValidator final : public Validator {
 public:
  InsertVerticesValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {}
...
class DeleteVerticesValidator final : public Validator {
 public:
  DeleteVerticesValidator(Sentence* sentence, QueryContext* context) : Validator(sentence, context) {}
...
class UpdateValidator : public Validator {
 ...
 private:
  Status checkAndResetSymExpr(Expression* inExpr, const std::string& symName, std::string& encodeStr);

  std::unique_ptr<Expression> rewriteSymExpr(Expression* expr, const std::string& sym, bool& hasWrongType,
                                             bool isEdge = false);
...
class UpdateVertexValidator final : public UpdateValidator {
 public:
  UpdateVertexValidator(Sentence* sentence, QueryContext* context) : UpdateValidator(sentence, context) {}
...
class UpdateEdgeValidator final : public UpdateValidator {
 public:
  UpdateEdgeValidator(Sentence* sentence, QueryContext* context) : UpdateValidator(sentence, context, true) {}
