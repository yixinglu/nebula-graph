...
class DeduceTypeVisitor final : public ExprVisitor {
 public:
  ...
  DeduceTypeVisitor(QueryContext *qctx, ValidateContext *vctx, const ColsDef &inputs, GraphSpaceID space);
 ...
 private:
  ...
  bool isSuperiorType(Value::Type type) { return type == Value::Type::NULLVALUE || type == Value::Type::__EMPTY__; }
