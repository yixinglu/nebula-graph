...
FindAnySubExprVisitor::FindAnySubExprVisitor(std::unordered_set<Expression *> &subExprs, bool needRecursiveSearch)
...
void FindAnySubExprVisitor::visit(ConstantExpression *expr) { compareWithSubExprs<ConstantExpression>(expr); }

void FindAnySubExprVisitor::visit(EdgePropertyExpression *expr) { compareWithSubExprs<EdgePropertyExpression>(expr); }

void FindAnySubExprVisitor::visit(TagPropertyExpression *expr) { compareWithSubExprs<TagPropertyExpression>(expr); }

void FindAnySubExprVisitor::visit(InputPropertyExpression *expr) { compareWithSubExprs<InputPropertyExpression>(expr); }
...
void FindAnySubExprVisitor::visit(DestPropertyExpression *expr) { compareWithSubExprs<DestPropertyExpression>(expr); }

void FindAnySubExprVisitor::visit(EdgeSrcIdExpression *expr) { compareWithSubExprs<EdgeSrcIdExpression>(expr); }

void FindAnySubExprVisitor::visit(EdgeTypeExpression *expr) { compareWithSubExprs<EdgeTypeExpression>(expr); }

void FindAnySubExprVisitor::visit(EdgeRankExpression *expr) { compareWithSubExprs<EdgeRankExpression>(expr); }

void FindAnySubExprVisitor::visit(EdgeDstIdExpression *expr) { compareWithSubExprs<EdgeDstIdExpression>(expr); }

void FindAnySubExprVisitor::visit(UUIDExpression *expr) { compareWithSubExprs<UUIDExpression>(expr); }

void FindAnySubExprVisitor::visit(VariableExpression *expr) { compareWithSubExprs<VariableExpression>(expr); }

void FindAnySubExprVisitor::visit(VersionedVariableExpression *expr) {
  compareWithSubExprs<VersionedVariableExpression>(expr);
}

void FindAnySubExprVisitor::visit(LabelExpression *expr) { compareWithSubExprs<LabelExpression>(expr); }

void FindAnySubExprVisitor::visit(VertexExpression *expr) { compareWithSubExprs<VertexExpression>(expr); }

void FindAnySubExprVisitor::visit(EdgeExpression *expr) { compareWithSubExprs<EdgeExpression>(expr); }

void FindAnySubExprVisitor::visit(ColumnExpression *expr) { compareWithSubExprs<ColumnExpression>(expr); }
