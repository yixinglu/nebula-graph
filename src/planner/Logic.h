...
class Select final : public BinarySelect {
 public:
  static Select* make(QueryContext* qctx, PlanNode* input, PlanNode* ifBranch, PlanNode* elseBranch,
 ...
 private:
  Select(QueryContext* qctx, PlanNode* input, PlanNode* ifBranch, PlanNode* elseBranch, Expression* condition)
...
class PassThroughNode final : public SingleInputNode {
 ...
 private:
  PassThroughNode(QueryContext* qctx, PlanNode* input) : SingleInputNode(qctx, Kind::kPassThrough, input) {}
};
