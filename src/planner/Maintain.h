...
class CreateSchemaNode : public SingleInputNode {
 protected:
  CreateSchemaNode(QueryContext* qctx, PlanNode* input, Kind kind, std::string name, meta::cpp2::Schema schema,
                   bool ifNotExists)
...
class CreateTag final : public CreateSchemaNode {
 public:
  static CreateTag* make(QueryContext* qctx, PlanNode* input, std::string tagName, meta::cpp2::Schema schema,
                         bool ifNotExists) {
    return qctx->objPool()->add(new CreateTag(qctx, input, std::move(tagName), std::move(schema), ifNotExists));
  }

 private:
  CreateTag(QueryContext* qctx, PlanNode* input, std::string tagName, meta::cpp2::Schema schema, bool ifNotExists)
      : CreateSchemaNode(qctx, input, Kind::kCreateTag, std::move(tagName), std::move(schema), ifNotExists) {}
};

class CreateEdge final : public CreateSchemaNode {
 public:
  static CreateEdge* make(QueryContext* qctx, PlanNode* input, std::string edgeName, meta::cpp2::Schema schema,
                          bool ifNotExists) {
    return qctx->objPool()->add(new CreateEdge(qctx, input, std::move(edgeName), std::move(schema), ifNotExists));
  }

 private:
  CreateEdge(QueryContext* qctx, PlanNode* input, std::string edgeName, meta::cpp2::Schema schema, bool ifNotExists)
      : CreateSchemaNode(qctx, input, Kind::kCreateEdge, std::move(edgeName), std::move(schema), ifNotExists) {}
};

class AlterSchemaNode : public SingleInputNode {
 protected:
  AlterSchemaNode(QueryContext* qctx, Kind kind, PlanNode* input, GraphSpaceID space, std::string name,
                  std::vector<meta::cpp2::AlterSchemaItem> items, meta::cpp2::SchemaProp schemaProp)
      : SingleInputNode(qctx, kind, input),
        space_(space),
        name_(std::move(name)),
...
class AlterTag final : public AlterSchemaNode {
 public:
  static AlterTag* make(QueryContext* qctx, PlanNode* input, GraphSpaceID space, std::string name,
                        std::vector<meta::cpp2::AlterSchemaItem> items, meta::cpp2::SchemaProp schemaProp) {
 ...
 private:
  AlterTag(QueryContext* qctx, PlanNode* input, GraphSpaceID space, std::string name,
           std::vector<meta::cpp2::AlterSchemaItem> items, meta::cpp2::SchemaProp schemaProp)
      : AlterSchemaNode(qctx, Kind::kAlterTag, input, space, std::move(name), std::move(items), std::move(schemaProp)) {
  }
};

class AlterEdge final : public AlterSchemaNode {
 public:
  static AlterEdge* make(QueryContext* qctx, PlanNode* input, GraphSpaceID space, std::string name,
                         std::vector<meta::cpp2::AlterSchemaItem> items, meta::cpp2::SchemaProp schemaProp) {
    return qctx->objPool()->add(
        new AlterEdge(qctx, input, space, std::move(name), std::move(items), std::move(schemaProp)));
  }

 private:
  AlterEdge(QueryContext* qctx, PlanNode* input, GraphSpaceID space, std::string name,
            std::vector<meta::cpp2::AlterSchemaItem> items, meta::cpp2::SchemaProp schemaProp)
      : AlterSchemaNode(qctx, Kind::kAlterEdge, input, space, std::move(name), std::move(items),
                        std::move(schemaProp)) {}
};
...
class ShowTags final : public SingleInputNode {
 public:
  static ShowTags* make(QueryContext* qctx, PlanNode* input) { return qctx->objPool()->add(new ShowTags(qctx, input)); }
...
class ShowEdges final : public SingleInputNode {
 ...
 private:
  ShowEdges(QueryContext* qctx, PlanNode* input) : SingleInputNode(qctx, Kind::kShowEdges, input) {}
};
...
class CreateIndexNode : public SingleInputNode {
 protected:
  CreateIndexNode(QueryContext* qctx, PlanNode* input, Kind kind, std::string schemaName, std::string indexName,
                  std::vector<meta::cpp2::IndexFieldDef> fields, bool ifNotExists)
      : SingleInputNode(qctx, kind, input),
...
class CreateTagIndex final : public CreateIndexNode {
 public:
  static CreateTagIndex* make(QueryContext* qctx, PlanNode* input, std::string tagName, std::string indexName,
                              std::vector<meta::cpp2::IndexFieldDef> fields, bool ifNotExists) {
    return qctx->objPool()->add(
        new CreateTagIndex(qctx, input, std::move(tagName), std::move(indexName), std::move(fields), ifNotExists));
  }

 private:
  CreateTagIndex(QueryContext* qctx, PlanNode* input, std::string tagName, std::string indexName,
                 std::vector<meta::cpp2::IndexFieldDef> fields, bool ifNotExists)
      : CreateIndexNode(qctx, input, Kind::kCreateTagIndex, std::move(tagName), std::move(indexName), std::move(fields),
                        ifNotExists) {}
};

class CreateEdgeIndex final : public CreateIndexNode {
 public:
  static CreateEdgeIndex* make(QueryContext* qctx, PlanNode* input, std::string edgeName, std::string indexName,
                               std::vector<meta::cpp2::IndexFieldDef> fields, bool ifNotExists) {
    return qctx->objPool()->add(
        new CreateEdgeIndex(qctx, input, std::move(edgeName), std::move(indexName), std::move(fields), ifNotExists));
  }

 private:
  CreateEdgeIndex(QueryContext* qctx, PlanNode* input, std::string edgeName, std::string indexName,
                  std::vector<meta::cpp2::IndexFieldDef> fields, bool ifNotExists)
      : CreateIndexNode(qctx, input, Kind::kCreateEdgeIndex, std::move(edgeName), std::move(indexName),
                        std::move(fields), ifNotExists) {}
};
...
class DropIndexNode : public SingleInputNode {
 protected:
  DropIndexNode(QueryContext* qctx, Kind kind, PlanNode* input, std::string indexName, bool ifExists)
      : SingleInputNode(qctx, kind, input), indexName_(std::move(indexName)), ifExists_(ifExists) {}
...
class DropTagIndex final : public DropIndexNode {
 public:
  static DropTagIndex* make(QueryContext* qctx, PlanNode* input, std::string indexName, bool ifExists) {
...
class DropEdgeIndex final : public DropIndexNode {
 public:
  static DropEdgeIndex* make(QueryContext* qctx, PlanNode* input, std::string indexName, bool ifExists) {
...
class ShowTagIndexes final : public SingleInputNode {
 ...
 private:
  ShowTagIndexes(QueryContext* qctx, PlanNode* input) : SingleInputNode(qctx, Kind::kShowTagIndexes, input) {}
};
...
class ShowEdgeIndexes final : public SingleInputNode {
 ...
 private:
  ShowEdgeIndexes(QueryContext* qctx, PlanNode* input) : SingleInputNode(qctx, Kind::kShowEdgeIndexes, input) {}
};
...
class ShowTagIndexStatus final : public SingleInputNode {
 ...
 private:
  ShowTagIndexStatus(QueryContext* qctx, PlanNode* input) : SingleInputNode(qctx, Kind::kShowTagIndexStatus, input) {}
};
...
class ShowEdgeIndexStatus final : public SingleInputNode {
 ...
 private:
  ShowEdgeIndexStatus(QueryContext* qctx, PlanNode* input) : SingleInputNode(qctx, Kind::kShowEdgeIndexStatus, input) {}
};
