...
class MatchPlanner final : public Planner {
 public:
  static std::unique_ptr<MatchPlanner> make() { return std::unique_ptr<MatchPlanner>(new MatchPlanner()); }
 ...
 private:
  StatusOr<SubPlan> connectSegments(std::vector<SubPlan>& subplans,
