...
class YieldClausePlanner final : public CypherClausePlanner {
 public:
  ...
  void rewriteYieldColumns(const YieldClauseContext* yctx, const YieldColumns* yields, YieldColumns* newYields);

  void rewriteGroupExprs(const YieldClauseContext* yctx, const std::vector<Expression*>* exprs,
