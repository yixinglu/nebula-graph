...
class CreateSpace final : public SingleDependencyNode {
 public:
  static CreateSpace* make(QueryContext* qctx, PlanNode* input, meta::cpp2::SpaceDesc spaceDesc, bool ifNotExists) {
 ...
 private:
  CreateSpace(QueryContext* qctx, PlanNode* input, meta::cpp2::SpaceDesc spaceDesc, bool ifNotExists)
...
class DropSpace final : public SingleDependencyNode {
 public:
  static DropSpace* make(QueryContext* qctx, PlanNode* input, std::string spaceName, bool ifExists) {
...
class ShowSpaces final : public SingleDependencyNode {
 ...
 private:
  explicit ShowSpaces(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowSpaces, input) {}
};
...
class SetConfig final : public SingleDependencyNode {
 public:
  static SetConfig* make(QueryContext* qctx, PlanNode* input, meta::cpp2::ConfigModule module, std::string name,
                         Value value) {
    return qctx->objPool()->add(new SetConfig(qctx, input, module, std::move(name), std::move(value)));
  }
 ...
 private:
  SetConfig(QueryContext* qctx, PlanNode* input, meta::cpp2::ConfigModule module, std::string name, Value value)
...
class GetConfig final : public SingleDependencyNode {
 public:
  static GetConfig* make(QueryContext* qctx, PlanNode* input, meta::cpp2::ConfigModule module, std::string name) {
 ...
 private:
  explicit GetConfig(QueryContext* qctx, PlanNode* input, meta::cpp2::ConfigModule module, std::string name)
      : SingleDependencyNode(qctx, Kind::kGetConfig, input), module_(module), name_(std::move(name)) {}
...
class AddListener final : public SingleDependencyNode {
 public:
  static AddListener* make(QueryContext* qctx, PlanNode* input, meta::cpp2::ListenerType type,
 ...
 private:
  explicit AddListener(QueryContext* qctx, PlanNode* input, meta::cpp2::ListenerType type, std::vector<HostAddr> hosts)
...
class ShowListener final : public SingleDependencyNode {
 ...
 private:
  explicit ShowListener(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowListener, input) {}
};

class Download final : public SingleDependencyNode {
 public:
  static Download* make(QueryContext* qctx, PlanNode* input, std::string hdfsHost, int32_t hdfsPort,
                        std::string hdfsPath) {
 ...
 private:
  explicit Download(QueryContext* qctx, PlanNode* dep, std::string hdfsHost, int32_t hdfsPort, std::string hdfsPath)
...
class Ingest final : public SingleDependencyNode {
 public:
  static Ingest* make(QueryContext* qctx, PlanNode* dep) { return qctx->objPool()->add(new Ingest(qctx, dep)); }

 private:
  explicit Ingest(QueryContext* qctx, PlanNode* dep) : SingleDependencyNode(qctx, Kind::kIngest, dep) {}
};

// User related Node
class CreateUser final : public CreateNode {
 public:
  static CreateUser* make(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* password,
                          bool ifNotExists) {
 ...
 private:
  CreateUser(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* password,
             bool ifNotExists)
      : CreateNode(qctx, Kind::kCreateUser, dep, ifNotExists), username_(username), password_(password) {}
...
class DropUser final : public DropNode {
 public:
  static DropUser* make(QueryContext* qctx, PlanNode* dep, const std::string* username, bool ifNotExists) {
...
class UpdateUser final : public SingleDependencyNode {
 public:
  static UpdateUser* make(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* password) {
 ...
 private:
  UpdateUser(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* password)
      : SingleDependencyNode(qctx, Kind::kUpdateUser, dep), username_(username), password_(password) {}
...
class GrantRole final : public SingleDependencyNode {
 public:
  static GrantRole* make(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* spaceName,
 ...
 private:
  GrantRole(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* spaceName,
            meta::cpp2::RoleType role)
      : SingleDependencyNode(qctx, Kind::kGrantRole, dep), username_(username), spaceName_(spaceName), role_(role) {}
...
class RevokeRole final : public SingleDependencyNode {
 public:
  static RevokeRole* make(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* spaceName,
                          meta::cpp2::RoleType role) {
 ...
 private:
  RevokeRole(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* spaceName,
             meta::cpp2::RoleType role)
      : SingleDependencyNode(qctx, Kind::kRevokeRole, dep), username_(username), spaceName_(spaceName), role_(role) {}
...
class ChangePassword final : public SingleDependencyNode {
 public:
  static ChangePassword* make(QueryContext* qctx, PlanNode* dep, const std::string* username,
                              const std::string* password, const std::string* newPassword) {
 ...
 private:
  ChangePassword(QueryContext* qctx, PlanNode* dep, const std::string* username, const std::string* password,
...
class ListUsers final : public SingleDependencyNode {
 public:
  static ListUsers* make(QueryContext* qctx, PlanNode* dep) { return qctx->objPool()->add(new ListUsers(qctx, dep)); }

 private:
  explicit ListUsers(QueryContext* qctx, PlanNode* dep) : SingleDependencyNode(qctx, Kind::kListUsers, dep) {}
};
...
class ShowParts final : public SingleDependencyNode {
 public:
  static ShowParts* make(QueryContext* qctx, PlanNode* input, GraphSpaceID spaceId, std::vector<PartitionID> partIds) {
 ...
 private:
  explicit ShowParts(QueryContext* qctx, PlanNode* input, GraphSpaceID spaceId, std::vector<PartitionID> partIds)
...
class SubmitJob final : public SingleDependencyNode {
 public:
  static SubmitJob* make(QueryContext* qctx, PlanNode* dep, meta::cpp2::AdminJobOp op, meta::cpp2::AdminCmd cmd,
 ...
 private:
  SubmitJob(QueryContext* qctx, PlanNode* dep, meta::cpp2::AdminJobOp op, meta::cpp2::AdminCmd cmd,
            const std::vector<std::string>& params)
...
class BalanceLeaders final : public SingleDependencyNode {
 ...
 private:
  explicit BalanceLeaders(QueryContext* qctx, PlanNode* dep) : SingleDependencyNode(qctx, Kind::kBalanceLeaders, dep) {}
};
...
class StopBalance final : public SingleDependencyNode {
 ...
 private:
  explicit StopBalance(QueryContext* qctx, PlanNode* dep) : SingleDependencyNode(qctx, Kind::kStopBalance, dep) {}
};
...
class ResetBalance final : public SingleDependencyNode {
 ...
 private:
  explicit ResetBalance(QueryContext* qctx, PlanNode* dep) : SingleDependencyNode(qctx, Kind::kResetBalance, dep) {}
};
...
class ShowCharset final : public SingleDependencyNode {
 ...
 private:
  ShowCharset(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowCharset, input) {}
};
...
class ShowCollation final : public SingleDependencyNode {
 ...
 private:
  ShowCollation(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowCollation, input) {}
};

class AddGroup final : public SingleDependencyNode {
 public:
  static AddGroup* make(QueryContext* qctx, PlanNode* input, std::string groupName,
                        std::vector<std::string> zoneNames) {
    return qctx->objPool()->add(new AddGroup(qctx, input, std::move(groupName), std::move(zoneNames)));
  }
 ...
 private:
  AddGroup(QueryContext* qctx, PlanNode* input, std::string groupName, std::vector<std::string> zoneNames)
...
class ListGroups final : public SingleDependencyNode {
 ...
 private:
  ListGroups(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowGroups, input) {}
};

class AddHostIntoZone final : public SingleDependencyNode {
 public:
  static AddHostIntoZone* make(QueryContext* qctx, PlanNode* input, std::string zoneName, HostAddr addresses) {
    return qctx->objPool()->add(new AddHostIntoZone(qctx, input, std::move(zoneName), std::move(addresses)));
  }
...
class DropHostFromZone final : public SingleDependencyNode {
 public:
  static DropHostFromZone* make(QueryContext* qctx, PlanNode* input, std::string zoneName, HostAddr addresses) {
    return qctx->objPool()->add(new DropHostFromZone(qctx, input, std::move(zoneName), std::move(addresses)));
  }
...
class AddZone final : public SingleDependencyNode {
 public:
  static AddZone* make(QueryContext* qctx, PlanNode* input, std::string zoneName, std::vector<HostAddr> addresses) {
    return qctx->objPool()->add(new AddZone(qctx, input, std::move(zoneName), std::move(addresses)));
  }
 ...
 private:
  AddZone(QueryContext* qctx, PlanNode* input, std::string zoneName, std::vector<HostAddr> addresses)
...
class ListZones final : public SingleDependencyNode {
 ...
 private:
  ListZones(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowZones, input) {}
};

class AddZoneIntoGroup final : public SingleDependencyNode {
 public:
  static AddZoneIntoGroup* make(QueryContext* qctx, PlanNode* input, std::string groupName, std::string zoneName) {
    return qctx->objPool()->add(new AddZoneIntoGroup(qctx, input, std::move(zoneName), std::move(groupName)));
  }
...
class DropZoneFromGroup final : public SingleDependencyNode {
 public:
  static DropZoneFromGroup* make(QueryContext* qctx, PlanNode* input, std::string groupName, std::string zoneName) {
    return qctx->objPool()->add(new DropZoneFromGroup(qctx, input, std::move(zoneName), std::move(groupName)));
  }
 ...
 private:
  DropZoneFromGroup(QueryContext* qctx, PlanNode* input, std::string zoneName, std::string groupName)
...
class ShowGroups final : public SingleDependencyNode {
 ...
 private:
  ShowGroups(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowGroups, input) {}
};
...
class ShowZones final : public SingleDependencyNode {
 ...
 private:
  ShowZones(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowZones, input) {}
};
...
class ShowStats final : public SingleDependencyNode {
 ...
 private:
  ShowStats(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowStats, input) {}
};
...
class ShowTSClients final : public SingleDependencyNode {
 ...
 private:
  ShowTSClients(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kShowTSClients, input) {}
};

class SignInTSService final : public SingleDependencyNode {
 public:
  static SignInTSService* make(QueryContext* qctx, PlanNode* input, std::vector<meta::cpp2::FTClient> clients) {
...
class SignOutTSService final : public SingleDependencyNode {
 ...
 private:
  SignOutTSService(QueryContext* qctx, PlanNode* input) : SingleDependencyNode(qctx, Kind::kSignOutTSService, input) {}
};
}  // namespace graph
}  // namespace nebula
