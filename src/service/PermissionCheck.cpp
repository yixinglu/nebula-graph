...
// static
Status PermissionCheck::permissionCheck(Session* session, Sentence* sentence, GraphSpaceID targetSpace) {
  ...
  return Status::Error("Impossible permission checking for sentence %d.", static_cast<int>(sentence->kind()));
}
}  // namespace graph
}  // namespace nebula
