...
class AddGroupExecutor final : public Executor {
 public:
  AddGroupExecutor(const PlanNode *node, QueryContext *qctx) : Executor("AddGroupExecutor", node, qctx) {}
...
class DropGroupExecutor final : public Executor {
 public:
  DropGroupExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DropGroupExecutor", node, qctx) {}
...
class DescribeGroupExecutor final : public Executor {
 public:
  DescribeGroupExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DescribeGroupExecutor", node, qctx) {}
...
class ListGroupsExecutor final : public Executor {
 public:
  ListGroupsExecutor(const PlanNode *node, QueryContext *qctx) : Executor("ListGroupsExecutor", node, qctx) {}
