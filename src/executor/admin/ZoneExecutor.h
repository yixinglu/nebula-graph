...
class AddZoneExecutor final : public Executor {
 public:
  AddZoneExecutor(const PlanNode *node, QueryContext *qctx) : Executor("AddZoneExecutor", node, qctx) {}
...
class DropZoneExecutor final : public Executor {
 public:
  DropZoneExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DropZoneExecutor", node, qctx) {}
...
class DescribeZoneExecutor final : public Executor {
 public:
  DescribeZoneExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DescribeZoneExecutor", node, qctx) {}
...
class AddHostIntoZoneExecutor final : public Executor {
 public:
  AddHostIntoZoneExecutor(const PlanNode *node, QueryContext *qctx) : Executor("AddHostIntoZoneExecutor", node, qctx) {}
...
class ListZonesExecutor final : public Executor {
 public:
  ListZonesExecutor(const PlanNode *node, QueryContext *qctx) : Executor("ListZonesExecutor", node, qctx) {}
