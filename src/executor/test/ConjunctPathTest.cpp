...
TEST_F(ConjunctPathTest, BiBFSNoPath) {
  auto* conjunct = ConjunctPath::make(qctx_.get(), StartNode::make(qctx_.get()), StartNode::make(qctx_.get()),
                                      ConjunctPath::PathKind::kBiBFS, 5);
...
TEST_F(ConjunctPathTest, AllPathsNoPath) {
  auto* conjunct = ConjunctPath::make(qctx_.get(), StartNode::make(qctx_.get()), StartNode::make(qctx_.get()),
                                      ConjunctPath::PathKind::kAllPaths, 5);
...
TEST_F(ConjunctPathTest, multiplePairOneStep) {
  auto* conjunct = ConjunctPath::make(qctx_.get(), StartNode::make(qctx_.get()), StartNode::make(qctx_.get()),
                                      ConjunctPath::PathKind::kFloyd, 5);
