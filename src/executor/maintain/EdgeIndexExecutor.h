...
class CreateEdgeIndexExecutor final : public Executor {
 public:
  CreateEdgeIndexExecutor(const PlanNode *node, QueryContext *qctx) : Executor("CreateEdgeIndexExecutor", node, qctx) {}
...
class DropEdgeIndexExecutor final : public Executor {
 public:
  DropEdgeIndexExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DropEdgeIndexExecutor", node, qctx) {}
...
class DescEdgeIndexExecutor final : public Executor {
 public:
  DescEdgeIndexExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DescEdgeIndexExecutor", node, qctx) {}
...
class ShowEdgeIndexesExecutor final : public Executor {
 public:
  ShowEdgeIndexesExecutor(const PlanNode *node, QueryContext *qctx) : Executor("ShowEdgeIndexesExecutor", node, qctx) {}
