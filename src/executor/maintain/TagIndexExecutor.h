...
class CreateTagIndexExecutor final : public Executor {
 public:
  CreateTagIndexExecutor(const PlanNode *node, QueryContext *qctx) : Executor("CreateTagIndexExecutor", node, qctx) {}
...
class DropTagIndexExecutor final : public Executor {
 public:
  DropTagIndexExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DropTagIndexExecutor", node, qctx) {}
...
class DescTagIndexExecutor final : public Executor {
 public:
  DescTagIndexExecutor(const PlanNode *node, QueryContext *qctx) : Executor("DescTagIndexExecutor", node, qctx) {}
...
class ShowTagIndexesExecutor final : public Executor {
 public:
  ShowTagIndexesExecutor(const PlanNode *node, QueryContext *qctx) : Executor("ShowTagIndexesExecutor", node, qctx) {}
