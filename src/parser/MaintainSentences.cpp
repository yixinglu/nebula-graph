...
std::string DropTagSentence::toString() const { return folly::stringPrintf("DROP TAG %s", name_.get()->c_str()); }

std::string DropEdgeSentence::toString() const { return folly::stringPrintf("DROP EDGE %s", name_.get()->c_str()); }
...
std::string ShowTagIndexesSentence::toString() const { return folly::stringPrintf("SHOW TAG INDEXES"); }

std::string ShowEdgeIndexesSentence::toString() const { return folly::stringPrintf("SHOW EDGE INDEXES"); }

std::string ShowTagIndexStatusSentence::toString() const { return folly::stringPrintf("SHOW TAG INDEX STATUS"); }

std::string ShowEdgeIndexStatusSentence::toString() const { return folly::stringPrintf("SHOW EDGE INDEX STATUS"); }
...
std::string DropZoneSentence::toString() const { return folly::stringPrintf("DROP ZONE %s", zoneName_.get()->c_str()); }
...
std::string AddZoneIntoGroupSentence::toString() const {
  return folly::stringPrintf("Add Zone %s Into Group %s", zoneName_.get()->c_str(), groupName_.get()->c_str());
}
...
std::string DropZoneFromGroupSentence::toString() const {
  return folly::stringPrintf("Drop Zone %s From Group %s", zoneName_.get()->c_str(), groupName_.get()->c_str());
}
