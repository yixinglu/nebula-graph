...
struct NodeContext final : PatternContext {
  NodeContext(MatchClauseContext* m, NodeInfo* i) : PatternContext(PatternKind::kNode, m), info(i) {}
...
struct EdgeContext final : PatternContext {
  EdgeContext(MatchClauseContext* m, EdgeInfo* i) : PatternContext(PatternKind::kEdge, m), info(i) {}
